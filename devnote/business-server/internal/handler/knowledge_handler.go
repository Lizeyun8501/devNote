...
func (h *KnowledgeHandler) CreateRelation(c *gin.Context) {
	...
	result, err := h.svc.CreateRelation(req.SourceNoteID, req.TargetNoteID, req.RelationType, req.Weight)
	if err != nil {
...
func (h *KnowledgeHandler) DeleteRelation(c *gin.Context) {
	id := c.Param("id")
	if err := h.svc.DeleteRelation(id); err != nil {
...
func (h *KnowledgeHandler) GetRelations(c *gin.Context) {
	...
	relations, err := h.svc.GetRelations(noteID)
	if err != nil {
...
func (h *KnowledgeHandler) ComputeEdges(c *gin.Context) {
	edges, err := h.svc.ComputeGraphEdges()
	if err != nil {
...
func (h *KnowledgeHandler) ComputeMetrics(c *gin.Context) {
	metrics, err := h.svc.ComputeMetrics()
	if err != nil {
...
func (h *KnowledgeHandler) SuggestRelated(c *gin.Context) {
	...
	suggestions, err := h.svc.SuggestRelatedNotes(noteID, limit)
	if err != nil {
...
func (h *KnowledgeHandler) FindShortestPath(c *gin.Context) {
	...
	path, distance, err := h.svc.FindShortestPath(from, to)
	if err != nil {
