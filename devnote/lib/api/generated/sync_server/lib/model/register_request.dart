...
class RegisterRequest {
  ...
  static RegisterRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'username'), 'Required key "RegisterRequest[username]" is missing from JSON.');
        assert(json[r'username'] != null, 'Required key "RegisterRequest[username]" has a null value in JSON.');
