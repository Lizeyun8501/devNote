// 修复(P2-1): 将 SearchService 注册到 DI 容器，消除页面中直接 new Service 绕过 DI 的问题。
...
/// 注册 Search 模块依赖
Future<void> registerSearchDependencies() async {
...
/// 释放 Search 模块资源
/// SearchService 依赖的 Dispatch 由 disposeCore() 统一释放，无需额外清理。
void disposeSearchModule() {
  // SearchService 无需显式释放资源
}
